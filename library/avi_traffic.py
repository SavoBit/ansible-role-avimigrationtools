...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            avi_vs_ip_address=dict(required=True),
            avi_vs_type=dict(required=True),
            avi_vs_port=dict(required=True),
            avi_vs_name=dict(required=True),
            avi_controller=dict(required=True),
            avi_con_username=dict(required=True),
            avi_con_password=dict(required=True),
            avi_con_tenant=dict()
        )
    )
    ...
    # Accessing arguments
    uri = module.params.get("avi_vs_ip_address", None)
    request_type = module.params.get('avi_vs_type', None)
    port = module.params.get('avi_vs_port', None)
    virtualservice_name = module.params.get('avi_vs_name', None)
    controller = module.params.get('avi_controller', None)
    password = module.params.get('avi_con_password', None)
    username = module.params.get('avi_con_username', None)
    tenant = module.params.get('avi_con_tenant', None)
