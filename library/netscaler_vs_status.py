...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ns_username=dict(required=True),
            ns_password=dict(required=True),
            vs_state=dict(required=True),
    ...
    # Accessing arguments
    username = module.params.get("ns_username")
    password = module.params.get('ns_password')
    state = module.params.get('vs_state')
